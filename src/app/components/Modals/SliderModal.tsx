...
const SliderModal = ({ isOpen, onClose }: SliderModalProps) => {
  const sliderItems: SliderItem[] = [
    { id: 1, image: "/cardimg.png", title: "20k Use", subtitle: "Monye Matt" },
    {
      id: 2,
      image: "/cardimg.png",
      title: "30k Use",
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/20 backdrop-blur-md">
      ...
      <div className="absolute inset-0">
        <Image
          src="/your-modal-bg.jpg" // <-- Change to your background image
          alt="Background"
          fill
      ...
      <button
        onClick={onClose}
        className="absolute top-5 right-5 text-white bg-black/60 hover:bg-black/80 rounded-full p-2 z-[110]"
      >
        ✕
      </button>

      {/* Modal content */}
      <div className="relative w-full max-w-4xl mx-auto min-h-[80vh] z-[105]">
        <div className="absolute inset-0 rounded-xl bg-black/25 backdrop-blur-sm pointer-events-none" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full h-full">
                    ...
                    />
                    <div
                      className="absolute inset-x-0 bottom-0 flex flex-col justify-end items-center p-6 z-30"
                      style={{
                        backgroundImage:
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white rounded-full p-3 z-[110]"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white rounded-full p-3 z-[110]"

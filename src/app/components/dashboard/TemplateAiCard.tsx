...
export function TemplateAiCard() {
  ...
  return (
    <section className="w-full max-w-[768px] mx-auto text-white font-sans p-4">
      {/* Top Gradient Header */}
      <div className="relative min-h-[60vh] sm:min-h-[60vh] bg-gradient-to-b from-[#9972ed] to-[#7c5ee9] rounded-[2rem] pt-10 sm:pt-14 pb-32 sm:pb-40 text-center overflow-hidden z-10">

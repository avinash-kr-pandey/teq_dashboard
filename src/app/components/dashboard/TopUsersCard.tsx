...
export function TopUsersCard() {
  return (
    <article className="flex flex-col justify-center px-8 py-9 mt-7 w-full aspect-[1.191] min-h-[220px] rounded-2xl bg-gradient-to-b from-[#1a172e] to-[#0f0d21] text-center text-white shadow-lg">
